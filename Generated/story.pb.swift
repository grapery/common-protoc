...
public struct Common_GetStoryInfoResponse: Sendable {
  ...
  public struct DataMessage: @unchecked Sendable {
    ...
    public var info: Common_Story {
      get {return _storage._info ?? Common_Story()}
    ...
    public var interact: Common_UserInteractStatus {
      get {return _storage._interact ?? Common_UserInteractStatus()}
      set {_uniqueStorage()._interact = newValue}
    }
    /// Returns true if `interact` has been explicitly set.
    public var hasInteract: Bool {return _storage._interact != nil}
    /// Clears the value of `interact`. Subsequent reads from it will return its default value.
    public mutating func clearInteract() {_uniqueStorage()._interact = nil}
...
public struct Common_GetStoryboardResponse: Sendable {
  ...
  public struct DataMessage: @unchecked Sendable {
    ...
    public var info: Common_StoryBoard {
      get {return _storage._info ?? Common_StoryBoard()}
      set {_uniqueStorage()._info = newValue}
    }
    /// Returns true if `info` has been explicitly set.
    public var hasInfo: Bool {return _storage._info != nil}
...
public struct Common_StoryBoardSence: Sendable {
  ...
  public var imagePrompts: String = String()

  public var audioPrompts: String = String()

  public var videoPrompts: String = String()

  public var isGenerating: Int32 = 0

  public var genResult: String = String()
...
extension Common_GetStoryInfoResponse.DataMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    var _info: Common_Story? = nil
    var _creator: Common_UserInfo? = nil
    var _interact: Common_UserInteractStatus? = nil
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 2: try { try decoder.decodeSingularMessageField(value: &_storage._creator) }()
        case 3: try { try decoder.decodeSingularMessageField(value: &_storage._interact) }()
        default: break
        }
      }
    }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      try { if let v = _storage._interact {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 3)
      } }()
    }
    try unknownFields.traverse(visitor: &visitor)
  ...
  public static func ==(lhs: Common_GetStoryInfoResponse.DataMessage, rhs: Common_GetStoryInfoResponse.DataMessage) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._creator != rhs_storage._creator {return false}
        if _storage._interact != rhs_storage._interact {return false}
        return true
      }
      if !storagesAreEqual {return false}
    }
...
extension Common_GetStoryboardResponse.DataMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    var _info: Common_StoryBoard? = nil
    var _creator: Common_UserInfo? = nil
    var _interact: Common_UserInteractStatus? = nil
...
extension Common_GetStoryboardsResponse.DataMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeRepeatedMessageField(value: &self.creator) }()
      case 3: try { try decoder.decodeRepeatedMessageField(value: &self.interact) }()
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.creator.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.creator, fieldNumber: 2)
    }
    if !self.interact.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.interact, fieldNumber: 3)
    }
    if self.isMultiBranch != false {
  ...
  public static func ==(lhs: Common_GetStoryboardsResponse.DataMessage, rhs: Common_GetStoryboardsResponse.DataMessage) -> Bool {
    ...
    if lhs.interact != rhs.interact {return false}
    if lhs.isMultiBranch != rhs.isMultiBranch {return false}
    if lhs.total != rhs.total {return false}
...
extension Common_FetchGroupStorysResponse.DataMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeRepeatedMessageField(value: &self.list) }()
      case 2: try { try decoder.decodeRepeatedMessageField(value: &self.interact) }()
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.interact.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.interact, fieldNumber: 2)
    }
    if !self.creator.isEmpty {
...
extension Common_StoryBoardSence: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeRepeatedStringField(value: &self.characterIds) }()
      case 4: try { try decoder.decodeSingularInt64Field(value: &self.creatorID) }()
      case 5: try { try decoder.decodeSingularInt64Field(value: &self.storyID) }()
      case 6: try { try decoder.decodeSingularInt64Field(value: &self.boardID) }()
      case 7: try { try decoder.decodeSingularStringField(value: &self.imagePrompts) }()
      case 8: try { try decoder.decodeSingularStringField(value: &self.audioPrompts) }()
      case 9: try { try decoder.decodeSingularStringField(value: &self.videoPrompts) }()
      case 10: try { try decoder.decodeSingularInt32Field(value: &self.isGenerating) }()
      case 11: try { try decoder.decodeSingularStringField(value: &self.genResult) }()
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.characterIds.isEmpty {
      try visitor.visitRepeatedStringField(value: self.characterIds, fieldNumber: 3)
    }
    if self.creatorID != 0 {
      try visitor.visitSingularInt64Field(value: self.creatorID, fieldNumber: 4)
    }
    if self.storyID != 0 {
      try visitor.visitSingularInt64Field(value: self.storyID, fieldNumber: 5)
    }
    if self.boardID != 0 {
      try visitor.visitSingularInt64Field(value: self.boardID, fieldNumber: 6)
    }
    if !self.imagePrompts.isEmpty {
      try visitor.visitSingularStringField(value: self.imagePrompts, fieldNumber: 7)
    }
    if !self.audioPrompts.isEmpty {
      try visitor.visitSingularStringField(value: self.audioPrompts, fieldNumber: 8)
    }
    if !self.videoPrompts.isEmpty {
      try visitor.visitSingularStringField(value: self.videoPrompts, fieldNumber: 9)
    }
    if self.isGenerating != 0 {
      try visitor.visitSingularInt32Field(value: self.isGenerating, fieldNumber: 10)
    }
    if !self.genResult.isEmpty {
      try visitor.visitSingularStringField(value: self.genResult, fieldNumber: 11)
    }
    if self.status != 0 {
  ...
  public static func ==(lhs: Common_StoryBoardSence, rhs: Common_StoryBoardSence) -> Bool {
    ...
    if lhs.storyID != rhs.storyID {return false}
    if lhs.boardID != rhs.boardID {return false}
    if lhs.imagePrompts != rhs.imagePrompts {return false}
    if lhs.audioPrompts != rhs.audioPrompts {return false}
    if lhs.videoPrompts != rhs.videoPrompts {return false}
    if lhs.isGenerating != rhs.isGenerating {return false}
    if lhs.genResult != rhs.genResult {return false}
    if lhs.status != rhs.status {return false}
