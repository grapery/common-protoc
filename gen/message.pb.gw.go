...
// UnaryRPC     :call StreamMessageServiceServer directly.
...
// RegisterStreamMessageServiceHandlerFromEndpoint is same as RegisterStreamMessageServiceHandler but
// automatically dials to "endpoint" and closes the connection when "ctx" gets done.
func RegisterStreamMessageServiceHandlerFromEndpoint(ctx context.Context, mux *runtime.ServeMux, endpoint string, opts []grpc.DialOption) (err error) {
	...
	return RegisterStreamMessageServiceHandler(ctx, mux, conn)
}

// RegisterStreamMessageServiceHandler registers the http handlers for service StreamMessageService to "mux".
// The handlers forward requests to the grpc endpoint over "conn".
func RegisterStreamMessageServiceHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterStreamMessageServiceHandlerClient(ctx, mux, NewStreamMessageServiceClient(conn))
}

// RegisterStreamMessageServiceHandlerClient registers the http handlers for service StreamMessageService
// to "mux". The handlers forward requests to the grpc endpoint over the given implementation of "StreamMessageServiceClient".
// Note: the gRPC framework executes interceptors within the gRPC handler. If the passed in "StreamMessageServiceClient"
